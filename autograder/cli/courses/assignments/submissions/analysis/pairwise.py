...
def run_cli(args: argparse.Namespace) -> int:
    ...
    result = autograder.api.courses.assignments.submissions.analysis.pairwise.send(config, exit_on_error = True)
...
def _get_parser() -> argparse.ArgumentParser:
    ...
    parser = autograder.cli.parser.get_parser(
        __doc__.strip(),
        autograder.api.courses.assignments.submissions.analysis.pairwise.API_PARAMS)
